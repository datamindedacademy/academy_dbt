...
recorded version. Two snapshot columns describe the validity of each row:
...
2. Create `snapshots/country_codes_snapshot.yml` with this definition.
   Which strategy fits this seed? Why?
